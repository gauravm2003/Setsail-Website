...
function Spain({
    title = "Spain Grand Tour",
    price = 3490,
    reviewCount = 128,
    rating = 5,
    description = "Experience the best of Spain on this 7-day guided journey. Explore vibrant cities like Madrid and Barcelona, stroll through Andalusia’s historic streets in Seville and Granada, and relax along the sun-drenched Costa del Sol.",
    quickInfo = [
        { label: "📅 7 Days", aria: "Tour Duration 7 Days" },
        { label: "👤 12+ Age", aria: "Minimum Age 12+" },
    ],
    details = {
        Destination:
            "Spain (Madrid, Barcelona, Seville, Granada, Costa del Sol)",
        Departure: "Madrid International Airport (Barajas)",
        "Departure Time": "Day 1, 10:00 AM",
        "Return Time": "Day 7, 8:00 PM",
        "Dress Code": "Casual, comfortable shoes; light jacket recommended",
        Included: [
            { label: "4-star and 5-star accommodations" },
            { label: "Daily breakfast & selected dinners" },
            { label: "Professional English-speaking tour guide" },
            { label: "High-speed train from Madrid to Barcelona" },
            { label: "Entrance tickets to Alhambra & Sagrada Família" },
        ],
        "Not Included": [
            { label: "International airfare" },
            { label: "Travel insurance" },
            { label: "Lunches & personal expenses" },
            { label: "Optional flamenco show in Seville" },
        ],
    },
    gallery = [
        "https://images.unsplash.com/photo-1528909514045-2fa4ac7a08ba?auto=format&fit=crop&w=800&q=60", // Madrid
        "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=800&q=60", // Barcelona
    ],
}) {
