...
function Tarragona({
    ...
    quickInfo = [
        { label: "📅 1", aria: "Tour Duration 1 Day" },
        { label: "👤 13+ Age", aria: "Minimum Age 13+" }
    ],
    details = {
        Destination: "Spain",
        ...
        Included: [{ label: "5 Star Accommodation" }],
        "Not Included": [{ label: "Gallery Ticket" }]
    },
    gallery = [
    ...
    return (
        <div className="position-relative">
            <div className="container py-5 d-flex flex-column flex-lg-row gap-5">
                ...
                <section className="flex-grow-1">
                    <h1 className="fs-2 fw-bold text-dark">
                        {title}{" "}
                        <span className="text-info fw-semibold ms-2 fs-5">${price}</span>{" "}
                        <span className="text-muted fw-normal fs-6">/per person</span>
                    </h1>
                    ...
                    <dl className="row row-cols-1 row-cols-sm-1 gy-3 gx-4 mt-5 text-muted small">
                        {Object.entries(details).map(([key, value], idx) => (
                            <div key={idx} className="d-flex justify-content-normal">
                                <dt className="fw-semibold text-dark w-25">{key}</dt>
                                <dd className="w-75">
                                    {Array.isArray(value) ? (
                    ...
                    {/* Gallery */}
                    <div className="mt-5">
                        <h2 className="fs-4 fw-bold text-dark mb-3">From our gallery</h2>
                        <p className="text-muted">Some highlights from the trip.</p>
                ...
                <aside className="w-100" style={{ maxWidth: "360px" }}>
                    ...
                    >
                        ...
                        <button type="submit" className="btn btn-outline-light w-100 fw-bold mb-2" style={{ fontSize: '14px' }}>
                            CHECK AVAILABILITY
                        </button>
                        <button type="submit" className="btn btn-outline-light w-100 fw-bold" style={{ fontSize: '14px' }}>
                            BOOK NOW
                        </button>
                    </form>
                </aside>
            ...
            >
                <button className="btn btn-danger fw-semibold text-uppercase" aria-label="View Related Tours">
                    Related
                </button>
                <button
