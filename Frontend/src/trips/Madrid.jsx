...
function Madrid({
    ...
    reviewCount = 12,
    rating = 4,
    description = "Discover the vibrant capital of Spain, known for its stunning architecture, world-class museums, and lively culture. From the Royal Palace to Puerta del Sol and the Prado Museum, Madrid offers a perfect mix of history and modern life.",
    quickInfo = [
        { label: "📅 3 Days", aria: "Tour Duration 3 Days" },
        { label: "👤 10+ Age", aria: "Minimum Age 10+" },
    ],
    details = {
        Destination: "Spain",
        Departure: "Puerta del Sol, Madrid",
        "Departure Time": "Approximately 9:00 AM",
        "Return Time": "Approximately 6:00 PM (Final Day)",
        "Dress Code": "Casual, comfortable clothing, walking shoes recommended",
        Included: [
            { label: "4-Star Accommodation" },
            { label: "Breakfast & Local Guide" },
            { label: "Airport Transfers" },
        ],
        "Not Included": [
            { label: "Airline Tickets" },
            { label: "Personal Expenses" },
            { label: "Optional Museum Tickets" },
        ],
    },
    gallery = [
